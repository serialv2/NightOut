...
public interface IDirectMessageService
{
    ...
    Task MarkAllConversationsReadAsync();
...
public interface INotificationService
{
    ...
    Task MarkReadByTypeAsync(params string[] types);
...
public interface IUserStatusService
{
    ...
    Task GoOfflineAsync();
    /// <summary>
    /// Prolonge expires_at de 1 heure. Appelé par HeartbeatService toutes les 2 min.
