    ...
    : BaseViewModel, IQueryAttributable
{
    ...
    [ObservableProperty] private Color _openStatusColor = Color.FromArgb("#7A8FA6");
    ...
    private void UpdateOpenStatus()
    {
        if (OpeningHours.Count == 0)
        {
            ...
            OpenStatusColor = Color.FromArgb("#7A8FA6");
        ...
        IsOpenNow = false;
        OpenStatusColor = Color.FromArgb("#FF6B35");
    ...
    {
        IsOpenNow = true;
        OpenStatusColor = Color.FromArgb("#22C55E");
