...
public class NightOutNotification : BaseModel
{
    ...
    public string DisplayTitle => string.IsNullOrWhiteSpace(Title) ? Type switch
    {
        ...
        "moderation_report_dismissed" => "Signalement examine",
        "moderation_report_action_taken" => "Signalement traite",
        "moderation_warning" => "Avertissement moderation",
    ...
    public string DisplayMessage => string.IsNullOrWhiteSpace(Message) ? Type switch
    {
        ...
        "moderation_report_dismissed" => "Votre signalement a ete examine.",
        "moderation_report_action_taken" => "Votre signalement a ete traite.",
        "moderation_warning" => "Vous avez recu un avertissement de moderation.",
        "moderation_ban" => "Votre compte a ete banni.",
        _ => Type
    } : Message!;
